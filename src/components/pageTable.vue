<template>
  <div ref="pgTable">
    ...
    <el-table
      ...
      <el-table-column v-if="!noIndex" type="index" width="50" :label="$t('overview.alarm.th1')" class-name="optBtn" align="center"></el-table-column>
    ...
    methods: {
      ...
      filterChange (filters) {
        ...
        if (!this.$store.state.query) {
          this.$parent.$refs.querycol && this.$parent.$refs.querycol.queryList();
